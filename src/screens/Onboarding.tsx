...
export default function Onboarding({ onDone }: { onDone: (toPlans?: boolean) => void }) {
          ...
          {step === 0 && (
            <div className="p-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="pt-2">
                  <Btn className="w-full" onClick={() => setStep(1)} disabled={!form.name || !form.email || form.password.length < 6}>
                    Continuar →
                  </Btn>
                </div>
          ...
          {step === 2 && (
            <div className="p-8">
              ...
              <div className="flex gap-3">
                <Btn variant="secondary" className="flex-1" onClick={() => onDone(false)}>
                  Ir ao Dashboard
                </Btn>
                <Btn className="flex-1" onClick={() => onDone(true)}>
                  Criar Plano →
                </Btn>
              </div>
            </div>
