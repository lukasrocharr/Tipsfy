    ...
    <div className="max-w-6xl mx-auto py-8 px-4 lg:px-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate('plans')} className="bg-emerald-500 hover:bg-emerald-400 text-white font-semibold px-4 py-2 rounded-lg transition-colors text-sm flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <button onClick={() => navigate('tips')} className="w-full text-xs text-emerald-400 hover:text-emerald-300 transition-colors text-center pt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="col-span-2 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e1e24]">
            ...
            <button onClick={() => navigate('subscribers')} className="text-xs text-emerald-400 hover:text-emerald-300 transition-colors">Ver todos →</button>
          </div>
          ...
          <Card className="p-5">
            ...
            <div className="space-y-2">
              {[
                ...
                <button key={a.screen} onClick={() => navigate(a.screen)} className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg hover:bg-[#18181c]/60 transition-colors group text-left">
            ...
            <Card className="p-5 border-red-900/40 bg-red-950/10">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <button onClick={() => navigate('subscribers')} className="text-xs text-red-400 hover:text-red-300 mt-2 transition-colors">Gerenciar →</button>
                </div>
              </div>
            </Card>
          )}
